    ...
    <div class="card mb-6">
        ...
        <div class="card-body">
            <div class="form-floating form-floating-outline mb-6">
                <input type="text" name="nombre" id="nombre" class="form-control campos" placeholder="Unidad">
                <label for="basic-default-fullname"><i class="bi bi-star"></i>&nbsp;Nombre</label>
            </div>
            <div class="form-floating form-floating-outline mb-6">
                <input type="text" name="codigo" id="codigo" class="form-control campos" placeholder="UND">
            ...
            boton("Crear", "check-lg", "outline-success", "crearUnidad()");
            ?>
        </div>
    </div>
</div>
...
<script>
    function crearUnidad() {
        ...
        AJAXPOST(urlBase + "pages/tienda/unidades/guardar.php", campos, div);
    }
</script>