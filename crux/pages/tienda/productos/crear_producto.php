        ...
        <div class="col-12 col-lg-8">
            <div class="card mb-6">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="bi bi-box">&nbsp;</i>Crear Producto</h5>
                    <small class="text-body float-end"><i class="bi bi-star">Campos Obligatorios</i></small>
                </div>
                <div class="card-body">
                    <div class="form-floating form-floating-outline mb-5">
                        <input type="text" class="form-control campos" id="nombre_producto" placeholder="Product title" name="nombre_producto">
                    ...
                    <div class="row mb-5 gx-5">
                        <div class="col">
                            <div class="form-floating form-floating-outline">
                                <input type="number" class="form-control campos" id="codigo_producto" placeholder="00000" name="codigo_producto">
                                <label for="codigo_producto"><i class="bi bi-star"></i>&nbsp;Código</label>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-floating form-floating-outline">
                                <input type="text" class="form-control campos" id="ecommerce-product-barcode" placeholder="0123-4567" name="codigo_barra">
        ...
        <div class="col-12 col-lg-4">
            <div class="card mb-4">
                ...
                <div class="card-body" style="display:flex;align-items:center;flex-direction:column;">
                    <img id="preview" src="<?=$sinImagen?>" alt="Sin imagen" width="300" height="300" style="border-radius:15px;"><br>
...
<script>
    function guardar() {
        ...
        xhr.open("POST", urlBase + "pages/tienda/productos/ajax/crear.php", true);
    ...
    function volver() {
        cargar_pagina("pages/tienda/productos/listado.php");
    }
