                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="overview-progress progress rounded-4 bg-transparent mb-2" style="height: 46px">
                      <div class="progress-bar small fw-medium text-start bg-primary px-1 px-lg-4" role="progressbar" style="width: 69.9%" aria-valuenow="28.3" aria-valuemin="0" aria-valuemax="100">
                        69.9%
                      </div>
                      <div class="progress-bar small fw-medium text-start rounded-start bg-lighter text-heading px-1 px-lg-4" role="progressbar" style="width: 30.1%" aria-valuenow="39.7" aria-valuemin="0" aria-valuemax="100">
                        30.1%
                      </div>
                    </div>  
                  </div>
